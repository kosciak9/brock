...
config :brock,
  ecto_repos: [Brock.Repo],
  generators: [timestamp_type: :utc_datetime],
  ash_domains: [Brock.Accounts],
...
config :brock, BrockWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: BrockWeb.ErrorHTML, json: BrockWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Brock.PubSub,
...
config :brock, Brock.Mailer, adapter: Swoosh.Adapters.Local

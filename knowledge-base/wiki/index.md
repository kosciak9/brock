...
| [Meta Deck, TCGdex, Card DSL, and LiveView Play North Star](engine/meta-deck-card-dsl-north-star.md) | North-star plan for moving the simulator from two fixed decklists to metadata-backed meta decks, authored behavior DSL overlays, pairwise smoke support, and a basic LiveView play UI. | 2026-05-29 |
